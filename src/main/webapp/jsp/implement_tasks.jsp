...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/implement_tasks.css">
    <script src="${pageContext.request.contextPath}/js/implement_tasks.js"></script>
