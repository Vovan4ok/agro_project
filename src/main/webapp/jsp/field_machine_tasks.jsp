...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/field_machine_tasks.css">
    <script src="${pageContext.request.contextPath}/js/field_machine_tasks.js"></script>
