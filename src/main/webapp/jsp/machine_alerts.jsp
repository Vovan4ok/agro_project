...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap"
          rel="stylesheet">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/machine_alerts.css">
    <script src="${pageContext.request.contextPath}/js/machine_alerts.js"></script>
</head>
