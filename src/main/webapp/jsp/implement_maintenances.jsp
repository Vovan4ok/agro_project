...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap"
          rel="stylesheet">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/implement_maintenances.css">
    <script src="${pageContext.request.contextPath}/js/implement_maintenances.js"></script>
</head>
...
<main class="main">
    ...
    <div class="main-content">
        <ul class="field-menu">
            ...
            <li class="field-menu-item">
                <a href="/implements/${implement.id}/maintenances" class="field-menu-link" style="font-weight: bold;">Обслуговування</a>
            </li>
            <li class="field-menu-item">
                ...
                <c:forEach var="maintenance_record_row" items="${maintenance_record_rows}">
                    <tr class="table-row table-td-row">
                        <td class="table-td type-cell">
                            <a href="/implements/${implement.id}/maintenances/${maintenance_record_row.maintenanceRecord.id}" class="type-link">${maintenance_record_row.maintenanceType.maintenanceTypeGroup.name}/${maintenance_record_row.maintenanceType.name}<br> ${maintenance_record_row.maintenanceRecord.id}</a>
                        </td>
