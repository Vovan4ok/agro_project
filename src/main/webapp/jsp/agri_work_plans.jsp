...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/agri_work_plans.css">
    <script src="${pageContext.request.contextPath}/js/agri_work_plans.js"></script>
