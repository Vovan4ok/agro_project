...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap"
          rel="stylesheet">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/implement_notes.css">
    <script src="${pageContext.request.contextPath}/js/implement_notes.js"></script>
</head>
...
<main class="main">
    ...
    <div class="main-content">
        <ul class="field-menu">
            ...
            <li class="field-menu-item">
                <a href="/implements/${implement.id}/notes" class="field-menu-link" style="font-weight: bold;">Нотатки</a>
            </li>
            <li class="field-menu-item">
