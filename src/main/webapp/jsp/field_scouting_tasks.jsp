...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/field_scouting_tasks.css">
    <script src="${pageContext.request.contextPath}/js/field_scouting_tasks.js"></script>
